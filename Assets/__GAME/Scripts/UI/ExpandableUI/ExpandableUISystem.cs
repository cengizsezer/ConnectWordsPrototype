...
public class ExpandableUISystem : MonoBehaviour
{
    ...
    public List<ExpandableChild> lsChild = new List<ExpandableChild>();
    public void Init(Transform Parent)
    {
        ...
        {
            lsChild.Add(Parent.GetChild(i + 1).GetComponent<ExpandableChild>());
    ...
    void OpenedMenu(ExpandableChild child,int idx)
    {
    ...
    void ClosedMenu(ExpandableChild child)
    {
