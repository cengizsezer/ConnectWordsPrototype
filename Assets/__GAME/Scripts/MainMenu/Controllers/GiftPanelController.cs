...
namespace MyProject.MainMenu.Controllers
{
    public class GiftPanelController : PanelController<GiftPanelController>, IDisposable
    {
        ...
        public void OpenGiftPanel(bool isOpen)
        {
            ...
            IsClaim = false;
            CoroutineMonoBehaviourParent.I.StartCoroutine(GiftBoxStartAnimation(() => currentGoldCount, () => IsClaim));
        }
...
public class CoroutineMonoBehaviourParent:PersistentSingleton<CoroutineMonoBehaviourParent>
{
